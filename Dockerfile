...
RUN ./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --with-pjproject-bundled \
 ...
 && menuselect/menuselect --disable-all \
    ...
    --enable func_callerid --enable func_curl --enable func_json --enable func_uuid --enable pbx_config --enable res_pjproject --enable res_pjsip --enable res_pjsip_authenticator_digest \
